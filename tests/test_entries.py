...
def test_store_retrieve_entry(create_entry, get_engine):
    ...
    entry_in = create_entry(ENTRY_ID, ENTRY_TITLE, ENTRY_TEXT, ENTRY_TAGS)
...
def test_store_retrieve_entry_multiple(create_entry, get_engine):
    ...
    create_entry(ENTRY_ID, ENTRY_TITLE, ENTRY_TEXT, ENTRY_TAGS).to_sql(get_engine)
    create_entry(ENTRY_ID + 1, ENTRY_TITLE, ENTRY_TEXT, ENTRY_TAGS).to_sql(get_engine)
    create_entry(ENTRY_ID + 2, ENTRY_TITLE, ENTRY_TEXT, ENTRY_TAGS).to_sql(get_engine)
